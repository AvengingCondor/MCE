...
public class Basalt extends Block implements IHasModel, IMetaName 
{
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "basalt_" + StoneEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
	...
	public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
	{
		...
		{
			drops.clear();
			drops.add(new ItemStack(BlockInit.BASALT, 1, 1));
		}
	}
}
